...
class Model(nn.Module):
    def __init__(self, num_class=60, num_point=25, num_person=2, graph=None, graph_args=dict(), in_channels=6,
        ...
        #3D-TA all
        if 1:
            self.l1 = TCNC_GCN_unit(6, 128, A, residual=False, adaptive=adaptive, attention=attention)
            self.l2 = TCNC_GCN_unit(128, 128, A, adaptive=adaptive, attention=attention)
            self.l3 = TCNC_GCN_unit(128, 128, A, adaptive=adaptive, attention=attention)
            ...
            self.l6 = TA_GCN3D_unit(256, 256, 150, A, adaptive=adaptive, attention=attention,inherent=0,head=1,dropout=0.0,pe=0)
            self.l7 = TA_GCN3D_unit(256, 256, 150, A, adaptive=adaptive, attention=attention,inherent=0,head=1,dropout=0.0,pe=0)
            self.l8 = TCNC_GCN3D_unit(256, 512, A, stride=2, adaptive=adaptive, attention=attention)
            self.l9 = TA_GCN3D_unit(512, 512, 75, A, adaptive=adaptive, attention=attention,inherent=0,head=1,dropout=0.0,pe=0)
            self.l10 = TA_GCN3D_unit(512, 512, 75, A, adaptive=adaptive, attention=attention,inherent=0,head=1,dropout=0.0,pe=0)
            output_emb = 512
        ...
        self.emb_dim = num_point * 512
        self.fc = KANLinear(output_emb, num_class)
